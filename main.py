...
# Piece class Objects
Pawn1 = Piece(0, 6, WP, Colour.WHITE)
Pawn2 = Piece(1, 6, WP, Colour.WHITE)
Pawn3 = Piece(2, 6, WP, Colour.WHITE)
Pawn4 = Piece(3, 6, WP, Colour.WHITE)
Pawn5 = Piece(4, 6, WP, Colour.WHITE)
Pawn6 = Piece(5, 6, WP, Colour.WHITE)
Pawn7 = Piece(6, 6, WP, Colour.WHITE)
Pawn8 = Piece(7, 6, WP, Colour.WHITE)
Pawn9 = Piece(0, 1, BP, Colour.BLACK)
Pawn10 = Piece(1, 1, BP, Colour.BLACK)
Pawn11 = Piece(2, 1, BP, Colour.BLACK)
Pawn12 = Piece(3, 1, BP, Colour.BLACK)
Pawn13 = Piece(4, 1, BP, Colour.BLACK)
Pawn14 = Piece(5, 1, BP, Colour.BLACK)
Pawn15 = Piece(6, 1, BP, Colour.BLACK)
Pawn16 = Piece(7, 1, BP, Colour.BLACK)
Knight1 = Piece(1, 7, WH, Colour.WHITE)
Knight2 = Piece(6, 7, WH, Colour.WHITE)
Knight3 = Piece(1, 0, BH, Colour.BLACK)
Knight4 = Piece(6, 0, BH, Colour.BLACK)
Rook1 = Piece(0, 7, WR, Colour.WHITE)
Rook2 = Piece(7, 7, WR, Colour.WHITE)
Rook3 = Piece(0, 0, BR, Colour.BLACK)
Rook4 = Piece(7, 0, BR, Colour.BLACK)
Bishop1 = Piece(2, 7, WB, Colour.WHITE)
Bishop2 = Piece(5, 7, WB, Colour.WHITE)
Bishop3 = Piece(2, 0, BB, Colour.BLACK)
Bishop4 = Piece(5, 0, BB, Colour.BLACK)
King1 = Piece(4, 7, WK, Colour.WHITE)
King2 = Piece(4, 0, BK, Colour.BLACK)
Queen1 = Piece(3, 7, WQ, Colour.WHITE)
Queen2 = Piece(3, 0, BQ, Colour.BLACK)
